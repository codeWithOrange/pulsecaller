...
const callProfiles = [
  CallProfile(
    label: 'Standard',
    description: 'Normal ring & vibration',
    accent: Color(0xFF38BDF8),
  ...
  CallProfile(
    label: 'Emergency',
    description: 'Continuous ring & flash',
...
const callTemplates = [
  CallTemplate(
    id: 'work_urgent',
    title: 'Work Meeting',
    description: 'Office meeting callback',
    category: 'Work',
    name: 'Rohit Sharma',
    number: '+91 98201 44521',
    carrier: 'SIM 1 - Jio 5G',
    note: 'Join the client update call.',
    delaySeconds: 15,
    repeatCount: 1,
    profileIndex: 1,
    vibrate: true,
  ...
  CallTemplate(
    ...
    description: 'Casual friend check-in',
    category: 'Personal',
    name: 'Rahul Verma',
    number: '+91 90000 12345',
    carrier: 'WhatsApp Audio',
    note: 'Call me back when you are free.',
    delaySeconds: 10,
    repeatCount: 1,
    profileIndex: 0,
    vibrate: true,
  ...
  CallTemplate(
    ...
    description: 'Courier parcel arrival',
    category: 'Delivery',
    name: 'Courier Delivery',
    number: '+91 91234 56789',
    carrier: 'Cellular',
  ...
  CallTemplate(
    id: 'family_reminder',
    title: 'Family Call',
    description: 'Home reminder call',
    category: 'Family',
    name: 'Mom',
    number: '+91 98765 43210',
    carrier: 'SIM 2 - Airtel',
    note: 'Call back when free.',
    delaySeconds: 30,
    repeatCount: 2,
    profileIndex: 0,
    vibrate: true,
